    ...
    <div className='brand container'>
            <form onSubmit={handleSubmit} className='mt-5 text-dark w-75'>
                <div className="form-group">
                    <input type="text" className="form-control form-control-lg" name="color" placeholder="Language "
    ...
    return (<div className="container-fluid text-dark ">
        ...
        <div className="row">
            ...
            <div className=" col   text-dark ">
                {loading ? <h2 className="text-center text-danger">Loading</h2> : <h2 className="text-center text-warning"><strong>Create </strong>Language</h2>}
